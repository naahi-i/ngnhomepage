...
const darkSvgContent = `<svg viewBox="0 0 1728 1117" preserveAspectRatio="xMinYMin slice" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_2_5)">
<g opacity="0.73">
<path d="M606 -123L1061 666H151L606 -123Z" fill="white" fill-opacity="0.15"/>
<path d="M190.15 144L67.3 -68.94L313 -68.94L190.15 144Z" fill="white" fill-opacity="0.15"/>
...
<g id="breathingParts">
<path fill-rule="evenodd" clip-rule="evenodd" d="M864 769C979.98 769 1074 674.98 1074 559C1074 443.02 979.98 349 864 349C748.02 349 654 443.02 654 559C654 674.98 748.02 769 864 769ZM864 749.909C969.436 749.909 1054.91 664.436 1054.91 559C1054.91 453.564 969.436 368.091 864 368.091C758.564 368.091 673.091 453.564 673.091 559C673.091 664.436 758.564 749.909 864 749.909Z" fill="#fee4ff" fill-opacity="0.9"/>
<path d="M934.636 392.273H792.727L757.091 447H970.909L934.636 392.273Z" fill="white" class="led-path" filter="url(#glow)"/>
<path d="M969.636 450.182H897.727L934.636 504.273L969.636 450.182Z" fill="white" class="led-path" filter="url(#glow)"/>
<path d="M792.091 500.455L828.364 447L900.909 555.182L863.364 609.273L792.091 500.455Z" fill="white" class="led-path" filter="url(#glow)"/>
<path d="M900.909 667.182L865.909 612.455L903.5 558.364L973.455 667.182L937.818 721.909H796.545L760.273 667.182L796.545 612.455L832.818 667.182H900.909Z" fill="white" class="led-path" filter="url(#glow)"/>
<defs>
  <filter id="glow">
    <feGaussianBlur stdDeviation="4" result="blur"/>
    <feFlood flood-color="#efe0fd" flood-opacity="2.5"/>
...
.splash-container {
  ...
  html[theme='dark'] & {
    background: linear-gradient(#c3bde9,
        #fee4ff);
  }
}
</style>
